...
@logger_model_training(version="1", additional="CNN-BiLSTM-CTC_CNN-64-128-256_BiLSTM-1dim")
...
def main(version, additional):
    ...
    # base_filename = f"cnn_lstm_ctc_handwritten_v1_initial"
    # model_filename = f"{base_filename}.pth"
    # torch.save(model.state_dict(), model_filename)

    # Load initial random weights (hardcoded path)
    # weights_path = "cnn_lstm_ctc_handwritten_v1_initial.pth"
