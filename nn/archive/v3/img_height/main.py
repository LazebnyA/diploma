...
from nn.logger import logger_decorator
...
@logger_decorator(version="4", additional="imgH-64")
def main():
    # Initialize nn paths
    paths = ProjectPaths()
    ...
    try:
        ...
        base_filename = f"cnn_lstm_ctc_handwritten_v4_{completed_epochs + 1}ep"
