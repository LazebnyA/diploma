...
class CNN_BiLSTM_CTC_V4(nn.Module):
...
@logger_model_training(version="4", additional="2-Layered-BiLSTM-imgAugment")
...
def main():
    ...
    dataset = IAMDataset(
        ...
        paths=paths,
        transform=get_augment_transform(img_height),
