...
from project.v1.main import CNN_LSTM_CTC_V1
from project.dataset import ProjectPaths, LabelConverter

# Load the trained model
model_path = "archive/cnn_lstm_ctc_handwritten_v1_75ep_full_train.pth"
...
model = CNN_LSTM_CTC_V1(img_height, num_channels, n_classes, n_h)
