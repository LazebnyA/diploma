...
class CNN_LSTM_CTC_V2(nn.Module):
...
@logger_model_training(version="2", additional="imgH-64")
def main():
    ...
    try:
        ...
        base_filename = f"cnn_lstm_ctc_handwritten_v2_{completed_epochs + 1}ep_imgH-64"
